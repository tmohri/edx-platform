...
def milestones_active(default=None):
    ...
    def wrap(f):  # pylint: disable=missing-docstring
        def function_wrapper(*args):  # pylint: disable=missing-docstring
...
@milestones_active(default=None)
...
def get_required_content(course_key, gated_content_key):
    ...
    Returns:
        tuple: The prerequisite content usage key and minimum score, (None, None) the the content is not gated
    """
