...
class TestCourseListGetForm(FormTestMixin, UsernameTestMixin, SharedModuleStoreTestCase):
    ...
    @ddt.data(
        ('mobile_available', True, 'mobile', True),
        ('mobile_available', False, 'mobile', False),
        ('mobile_available', True, 'mobile', "1"),
        ('mobile_available', False, 'mobile', "0"),
        ('mobile_available', None, 'mobile', None),
    )
    @ddt.unpack
    def test_filter(self, field_name, field_value, param_name, param_value):
