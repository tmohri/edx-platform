...
define(['jquery', 'backbone', 'underscore', 'gettext', 'js/views/baseview',
    ...
    var CourseOutlineXBlockModal, SettingsXBlockModal, PublishXBlockModal, AbstractEditor, BaseDateEditor,
        ...
        VerificationAccessEditor, TimedExaminationPreferenceEditor, GatingEditor;
    ...
    GatingEditor = AbstractEditor.extend({
        templateName: 'gating-editor',
        className: 'edit-settings-gating',
        events : {
            'change #prereq': 'handlePrereqSelect',
            'keyup #prereq_min_score': 'validate'
        },
        afterRender: function () {
            AbstractEditor.prototype.afterRender.call(this);
        ...
        getRequestData: function () {
            return {
                ...
                prereqMinScore: this.$('#prereq_min_score').val()
            };
        }
    });
