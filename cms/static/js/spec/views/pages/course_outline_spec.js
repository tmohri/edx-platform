        ...
        describe("CourseOutlinePage", function() {
            ...
            describe("Subsection", function() {
                var getDisplayNameWrapper, setEditModalValues, mockServerValuesJson,
                    selectDisableSpecialExams, selectBasicSettings, selectSpecialExamSettings,
                    selectGatingSettings, selectTimedExam, selectProctoredExam, selectPracticeExam,
                ...
                selectSpecialExamSettings = function() {
                   this.$(".modal-section .settings-tab-button[data-tab='special-exam']").click();
                };

                selectGatingSettings = function() {
                   this.$(".modal-section .settings-tab-button[data-tab='gating']").click();
                };
                ...
                it('can show basic settings', function() {
                    ...
                    expect($('.modal-section .settings-tab-button[data-tab="special-exam"]')).not.toHaveClass('active');
                    expect($('.modal-section .settings-tab-button[data-tab="gating"]')).not.toHaveClass('active');
                });

                it('can show special exam settings', function() {
                    createCourseOutlinePage(this, mockCourseJSON, false);
                    outlinePage.$('.outline-subsection .configure-button').click();
                    selectSpecialExamSettings();
                    expect($('.modal-section .settings-tab-button[data-tab="basic"]')).not.toHaveClass('active');
                    expect($('.modal-section .settings-tab-button[data-tab="special-exam"]')).toHaveClass('active');
                    expect($('.modal-section .settings-tab-button[data-tab="gating"]')).not.toHaveClass('active');
                });

                it('can show gating settings', function() {
                    createCourseOutlinePage(this, mockCourseJSON, false);
                    outlinePage.$('.outline-subsection .configure-button').click();
                    selectGatingSettings();
                    expect($('.modal-section .settings-tab-button[data-tab="basic"]')).not.toHaveClass('active');
                    expect($('.modal-section .settings-tab-button[data-tab="special-exam"]')).not.toHaveClass('active');
                    expect($('.modal-section .settings-tab-button[data-tab="gating"]')).toHaveClass('active');
                });
